.. _community.missing_collection.consul_status_module:
...
--------
- Get information from Consul (Status).
- https://www.consul.io/api-docs/status
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>get information about current leader.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>get information about all the peers.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <div style="font-size: small">
                      <span style="color: purple">str/list</span>
                    </div>
                </td>
                <td>when success.</td>
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">10.1.10.12:8300</div>
                </td>
            </tr>
    </table>
    <br/><br/>
