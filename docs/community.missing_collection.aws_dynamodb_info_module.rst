.. _community.missing_collection.aws_dynamodb_info_module:


**********************************************
community.missing_collection.aws_dynamodb_info
**********************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>arn of table.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: table_arn</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to describe global table <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to describe table <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of backups for given <em>name</em> and <em>backup_type</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_contributor_insights</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of contributor insights for given <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of export jobs for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_global_tables</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of global tables?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_backups` is defined and success</td>
                <td>
                            <div>list of backups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>contributor_insights</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_contributor_insights` is defined and success</td>
                <td>
                            <div>list of contributor insights.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_exports` is defined and success</td>
                <td>
                            <div>list of exports.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_global_table` is defined and success</td>
                <td>
                            <div>details about given global table name.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_global_tables` is defined and success</td>
                <td>
                            <div>list of global tables.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_table` is defined and success</td>
                <td>
                            <div>details about given table name.</div>
                    <br/>
                </td>
            </tr>
            <tr>
