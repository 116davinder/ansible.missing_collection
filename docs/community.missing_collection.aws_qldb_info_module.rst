.. _community.missing_collection.aws_qldb_info_module:


******************************************
community.missing_collection.aws_qldb_info
******************************************
...
--------
- Get Information about Amazon QLDB.
- https://docs.aws.amazon.com/qldb/latest/developergunamee/API_Operations_Amazon_QLDB.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_journal_kinesis_streams_for_ledger</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get journal_kinesis_streams_for_ledger for given ledger <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_journal_s3_exports</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of journal_s3_exports?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_journal_s3_exports_for_ledger</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of journal_s3_exports_for_ledger for given ledger <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of ledgers?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>name of the ledger.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: ledger_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>journal_kinesis_streams_for_ledger</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_journal_kinesis_streams_for_ledger` is defined and success.</td>
                <td>
                            <div>list of journal_kinesis_streams_for_ledger.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>journal_s3_exports</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_journal_s3_exports` is defined and success.</td>
                <td>
                            <div>list of journal_s3_exports.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>journal_s3_exports_for_ledger</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_journal_s3_exports_for_ledger` is defined and success.</td>
                <td>
                            <div>get of journal_s3_exports_for_ledger.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_ledgers` is defined and success.</td>
                <td>
                            <div>list of ledgers.</div>
                    <br/>
                </td>
            </tr>
    </table>
