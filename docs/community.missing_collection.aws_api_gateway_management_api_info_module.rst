.. _community.missing_collection.aws_api_gateway_management_api_info_module:


****************************************************************
community.missing_collection.aws_api_gateway_management_api_info
****************************************************************

**Get details about Amazon API Gateway Management API.**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>connection id of api gateway management api.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to fetch details about given <em>connection_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `get_connection` and `connection_id` and success</td>
                <td>
                            <div>details about given connection id.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;connected_at&#x27;: &#x27;datetime(2017&#x27;, 7: None, &#x27;7)&#x27;: None, &#x27;identity&#x27;: {&#x27;source_ip&#x27;: &#x27;string&#x27;, &#x27;user_agent&#x27;: &#x27;string&#x27;}, &#x27;last_acctive_at&#x27;: &#x27;datetime(2015&#x27;, 1: None, &#x27;1)&#x27;: None}</div>
                </td>
            </tr>
    </table>
    <br/><br/>
