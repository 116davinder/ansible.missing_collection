    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>get_configuration_set_event_destinations</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of configuration_set_event_destinations for given configuration set <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>configuration set name.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: configuration_set_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>configuration_set_event_destinations</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `get_configuration_set_event_destinations` is defined and success.</td>
                <td>
                            <div>list of configuration_set_event_destinations.</div>
                    <br/>
                </td>
            </tr>
    </table>
