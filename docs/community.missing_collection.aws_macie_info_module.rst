.. _community.missing_collection.aws_macie_info_module:


*******************************************
community.missing_collection.aws_macie_info
*******************************************
...
--------
- Get Information about Amazon Macie.
- https://docs.aws.amazon.com/macie/1.0/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of member_accounts?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_s3_resources</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of s3_resources for given <em>id</em>)?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>list of member_accounts.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_s3_resources` is defined and success.</td>
                <td>
                            <div>list of s3_resources.</div>
                    <br/>
                </td>
            </tr>
    </table>
