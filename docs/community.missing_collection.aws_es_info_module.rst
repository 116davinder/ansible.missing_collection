.. _community.missing_collection.aws_es_info_module:


****************************************
community.missing_collection.aws_es_info
****************************************
...
--------
- Get Information about Amazon Elasticsearch Service.
- https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-configuration-api.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_elasticsearch_domain</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get domain details of given <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_elasticsearch_domain_config</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get domain config details of given <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of packages for given <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>name of elastic search domain.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_elasticsearch_domain_config` is defined and success</td>
                <td>
                            <div>details about given domain config.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                            <div>list of all es domains.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_elasticsearch_domain` is defined and success</td>
                <td>
                            <div>details about given domain.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_packages_for_domain` is defined and success</td>
                <td>
