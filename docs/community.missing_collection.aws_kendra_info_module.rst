.. _community.missing_collection.aws_kendra_info_module:


********************************************
community.missing_collection.aws_kendra_info
********************************************
...
--------
- Get Information about AWS KendraFrontendService.
- https://docs.aws.amazon.com/kendra/latest/dg/API_Operations.html
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: datasource_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_data_source_sync_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of data_source_sync_jobs for given index <em>index_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_data_sources</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of data_sources for given index <em>index_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of configuration revisions for given index <em>index_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of indices?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of thesauri for given index <em>index_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    ...
                                    <li>STOPPING</li>
                                    <li>ABORTED</li>
                                    <li>SYNCING_INDEXING</li>
                        </ul>
                </td>
                <td>
                        <div>status to filter data source sync jobs.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>data_source_sync_jobs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_data_source_sync_jobs` is defined and success.</td>
                <td>
                            <div>list of data_source_sync_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_data_sources` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `list_faqs` is defined and success.</td>
                <td>
                            <div>list of faqs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_indices` is defined and success.</td>
                <td>
                            <div>list of indices.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_thesauri` is defined and success.</td>
                <td>
                            <div>list of thesauri.</div>
                    <br/>
                </td>
            </tr>
    </table>
