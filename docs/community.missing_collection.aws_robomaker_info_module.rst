.. _community.missing_collection.aws_robomaker_info_module:


***********************************************
community.missing_collection.aws_robomaker_info
***********************************************
...
--------
- Get Information about Amazon Robomaker.
- https://docs.aws.amazon.com/robomaker/latest/dg/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of deployment_jobs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get fleets?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_robot_applications</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of robot_applications?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get robots?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_simulation_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get simulation_jobs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get worlds?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_deployment_jobs` is defined and success.</td>
                <td>
                            <div>list of deployment_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>robot_applications</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_robot_applications` is defined and success.</td>
                <td>
                            <div>list of robot_applications.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_robots` is defined and success.</td>
                <td>
                            <div>list of robots.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_simulation_jobs` is defined and success.</td>
                <td>
                            <div>list of simulation_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_worlds` is defined and success.</td>
                <td>
                            <div>list of worlds.</div>
                    <br/>
                </td>
            </tr>
    </table>
