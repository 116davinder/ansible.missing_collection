.. _community.missing_collection.aws_mediaconvert_info_module:


**************************************************
community.missing_collection.aws_mediaconvert_info
**************************************************
...
--------
- Get Information about AWS Elemental MediaConvert.
- https://docs.aws.amazon.com/mediaconvert/latest/api/resources.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of job_templates?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of jobs for given <em>job_status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of presets?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of queues?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_job_templates` is defined and success.</td>
                <td>
                            <div>list of job_templates.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>when `list_presets` is defined and success.</td>
                <td>
                            <div>list of presets.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_queues` is defined and success.</td>
                <td>
                            <div>list of queues.</div>
                    <br/>
                </td>
            </tr>
    </table>
