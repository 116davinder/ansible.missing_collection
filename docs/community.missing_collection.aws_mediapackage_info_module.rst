.. _community.missing_collection.aws_mediapackage_info_module:


**************************************************
community.missing_collection.aws_mediapackage_info
**************************************************
...
--------
- Get Information about AWS Elemental MediaPackage.
- https://docs.aws.amazon.com/mediapackage/latest/apireference/resources.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>channel id.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: channel_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of harvest_jobs for given <em>job_status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_origin_endpoints</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of origin_endpoints for given channel <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_harvest_jobs` is defined and success.</td>
                <td>
                            <div>list of harvest_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>origin_endpoints</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_origin_endpoints` is defined and success.</td>
                <td>
                            <div>list of origin_endpoints.</div>
                    <br/>
                </td>
            </tr>
    </table>
