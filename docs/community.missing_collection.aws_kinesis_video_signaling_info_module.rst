.. _community.missing_collection.aws_kinesis_video_signaling_info_module:


*************************************************************
community.missing_collection.aws_kinesis_video_signaling_info
*************************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of shards for given channel <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>ice_server_config</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `get_ice_server_config` is defined and success.</td>
                <td>
                            <div>list of ice server config.</div>
                    <br/>
                </td>
            </tr>
    </table>
