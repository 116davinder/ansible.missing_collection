.. _community.missing_collection.aws_servicediscovery_info_module:


******************************************************
community.missing_collection.aws_servicediscovery_info
******************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>can be service id?</div>
                        <div>can be namespace id?</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: service_id, namespace_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of instances for given service <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get namespaces?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of services for given namespace <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_namespaces` is defined and success.</td>
                <td>
                            <div>list of namespaces.</div>
                    <br/>
                </td>
            </tr>
            <tr>
