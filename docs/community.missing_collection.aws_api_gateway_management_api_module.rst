.. _community.missing_collection.aws_api_gateway_management_api_module:


***********************************************************
community.missing_collection.aws_api_gateway_management_api
***********************************************************
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">bytes</span>
                    </div>
                </td>
                <td>
                </td>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to delete given <em>connection_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to delete given <em>connection_id</em> and <em>data</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
