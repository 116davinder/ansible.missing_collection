.. _community.missing_collection.couchdb_db_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to create partitioned database?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>number of replicas for <em>database</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>number of shards for <em>database</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
