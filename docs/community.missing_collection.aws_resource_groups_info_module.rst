.. _community.missing_collection.aws_resource_groups_info_module:


*****************************************************
community.missing_collection.aws_resource_groups_info
*****************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get group_resources for given group <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_group_resources` is defined and success.</td>
                <td>
                            <div>get of group_resources.</div>
                    <br/>
                </td>
            </tr>
            <tr>
