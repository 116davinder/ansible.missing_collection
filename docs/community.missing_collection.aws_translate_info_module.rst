.. _community.missing_collection.aws_translate_info_module:


***********************************************
community.missing_collection.aws_translate_info
***********************************************
...
--------
- Get Information about Amazon Translate.
- https://docs.aws.amazon.com/translate/latest/dg/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of parallel_data?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_terminologies</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get terminologies?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_text_translation_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of text_translation_jobs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_parallel_data` is defined and success.</td>
                <td>
                            <div>list of parallel_data.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_terminologies` is defined and success.</td>
                <td>
                            <div>list of terminologies.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>text_translation_jobs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_text_translation_jobs` is defined and success.</td>
                <td>
                            <div>list of text_translation_jobs.</div>
                    <br/>
                </td>
            </tr>
    </table>
