.. _community.missing_collection.aws_polly_info_module:


*******************************************
community.missing_collection.aws_polly_info
*******************************************
...
--------
- Get Information about Amazon Polly.
- https://docs.aws.amazon.com/polly/latest/dg/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of lexicons?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_speech_synthesis_tasks</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get speech_synthesis_tasks for given <em>status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>scheduled</li>
                                    <li><div style="color: blue"><b>inProgress</b>&nbsp;&larr;</div></li>
                                    <li>completed</li>
                                    <li>failed</li>
                        </ul>
                </td>
                <td>
                        <div>status of speech synthesis tasks.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_lexicons` is defined and success.</td>
                <td>
                            <div>list of lexicons.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>speech_synthesis_tasks</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_speech_synthesis_tasks` is defined and success.</td>
                <td>
                            <div>get of speech_synthesis_tasks.</div>
                    <br/>
                </td>
            </tr>
    </table>
