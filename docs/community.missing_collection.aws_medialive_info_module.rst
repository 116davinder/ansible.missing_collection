.. _community.missing_collection.aws_medialive_info_module:


***********************************************
community.missing_collection.aws_medialive_info
***********************************************
...
--------
- Get Information about AWS Elemental MediaLive.
- https://docs.aws.amazon.com/medialive/latest/api/resources.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_input_device_transfers</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of input_device_transfers for given <em>transfer_type</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_input_devices</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of input_devices?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_input_security_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of input_security_groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of inputs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_multiplex_programs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of multiplex_programs for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of offerings?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_reservations</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of reservations?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>OUTGOING</li>
                                    <li><div style="color: blue"><b>INCOMING</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_channels` is defined and success.</td>
                <td>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>input_device_transfers</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_input_device_transfers` is defined and success.</td>
                <td>
                            <div>list of input_device_transfers.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_input_devices` is defined and success.</td>
                <td>
                            <div>list of input_devices.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>input_security_groups</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_input_security_groups` is defined and success.</td>
                <td>
                            <div>list of input_security_groups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_inputs` is defined and success.</td>
                <td>
                            <div>list of inputs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>multiplex_programs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_multiplex_programs` is defined and success.</td>
                <td>
                            <div>list of multiplex_programs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_multiplexes` is defined and success.</td>
                <td>
                            <div>list of multiplexes.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_offerings` is defined and success.</td>
                <td>
                            <div>list of offerings.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_reservations` is defined and success.</td>
                <td>
                            <div>list of reservations.</div>
                    <br/>
                </td>
            </tr>
    </table>
