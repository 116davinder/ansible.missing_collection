.. _community.missing_collection.aws_kms_info_module:


*****************************************
community.missing_collection.aws_kms_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>id of key.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: key_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of grants for given key <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_key_policies</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of key policies for given key <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of keys?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_retirable_grants</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of retirable_grants for given <em>retiring_principal</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>id of retiring principal for grants.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_grants` or `list_retirable_grants` is defined and success.</td>
                <td>
                            <div>list of grants.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_key_policies` is defined and success.</td>
                <td>
                            <div>list of key_policies.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_keys` is defined and success.</td>
                <td>
