.. _community.missing_collection.aws_servicecatalog_appregistry_info_module:


****************************************************************
community.missing_collection.aws_servicecatalog_appregistry_info
****************************************************************
...
--------
- Get Information about AWS Service Catalog App Registry.
- https://docs.aws.amazon.com/servicecatalog_appregistry/1.0/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of applications?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_associated_attribute_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get associated_attribute_groups for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_associated_resources</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of associated_resources for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_applications` is defined and success.</td>
                <td>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>associated_attribute_groups</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_associated_attribute_groups` is defined and success.</td>
                <td>
                            <div>get of associated_attribute_groups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_associated_resources` is defined and success.</td>
                <td>
                            <div>list of associated_resources.</div>
                    <br/>
                </td>
            </tr>
    </table>
