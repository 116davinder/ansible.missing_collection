.. _community.missing_collection.aws_logs_info_module:


******************************************
community.missing_collection.aws_logs_info
******************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of destinations?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_export_tasks</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of export_tasks for given <em>task_status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_log_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of log_groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_log_streams</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of log_streams for given log group name <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_metric_filters</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of metric_filters for given log group name <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_queries</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of queries for given log group name <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>name of log group.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: log_stream_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_destinations` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `describe_export_tasks` is defined and success.</td>
                <td>
                            <div>list of export_tasks.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_log_groups` is defined and success.</td>
                <td>
                            <div>list of log_groups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_log_streams` is defined and success.</td>
                <td>
                            <div>list of log_streams.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_metric_filters` is defined and success.</td>
                <td>
                            <div>list of metric_filters.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_queries` is defined and success.</td>
                <td>
