.. _community.missing_collection.aws_wellarchitected_info_module:


*****************************************************
community.missing_collection.aws_wellarchitected_info
*****************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>id of workload.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: workload_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of lenses?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get milestones for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get notifications for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get workloads for given <em>prefix</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>workload name prefix.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: workload_name_prefix</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_lenses` is defined and success.</td>
                <td>
                            <div>list of lenses.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_milestones` is defined and success.</td>
                <td>
                            <div>list of milestones.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>when `list_workloads` is defined and success.</td>
                <td>
                            <div>list of workloads.</div>
                    <br/>
                </td>
            </tr>
    </table>
