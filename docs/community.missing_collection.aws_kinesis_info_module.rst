.. _community.missing_collection.aws_kinesis_info_module:


*********************************************
community.missing_collection.aws_kinesis_info
*********************************************
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: stream_arn</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of shards for given stream <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_stream_consumers</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of stream_consumers for given stream <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of streams?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>name of stream.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: stream_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_shards` is defined and success.</td>
                <td>
                            <div>list of shards.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>stream_consumers</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_stream_consumers` is defined and success.</td>
                <td>
                            <div>list of stream_consumers.</div>
                    <br/>
                </td>
            </tr>
            <tr>
