.. _community.missing_collection.aws_swf_info_module:


*****************************************
community.missing_collection.aws_swf_info
*****************************************
...
--------
- Get Information about Amazon Simple Workflow Service (SWF).
- https://docs.aws.amazon.com/swf/latest/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of activity_types for given <em>domain</em> and <em>registration_status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get domains for given <em>registration_status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_workflow_types</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of workflow_types for given <em>domain</em> and <em>registration_status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>REGISTERED</b>&nbsp;&larr;</div></li>
                                    <li>DEPRECATED</li>
                        </ul>
                </td>
                <td>
                        <div>registration status of workflow.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_activity_types` is defined and success.</td>
                <td>
                            <div>list of activity_types.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>when `list_workflow_types` is defined and success.</td>
                <td>
                            <div>list of workflow_types.</div>
                    <br/>
                </td>
            </tr>
    </table>
