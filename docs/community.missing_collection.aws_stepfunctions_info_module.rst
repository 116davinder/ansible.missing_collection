.. _community.missing_collection.aws_stepfunctions_info_module:


***************************************************
community.missing_collection.aws_stepfunctions_info
***************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>arn of the state machine.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: state_machine_arn</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get state_machine for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of activities?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get executions for given <em>arn</em> and <em>status_filter</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_state_machines</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of state_machines?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>filter to list executions?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_activities` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `list_executions` is defined and success.</td>
                <td>
                            <div>list of executions.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_state_machine` is defined and success.</td>
                <td>
                            <div>get details of state_machine.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_state_machines` is defined and success.</td>
                <td>
                            <div>list of state_machines.</div>
                    <br/>
                </td>
            </tr>
    </table>
