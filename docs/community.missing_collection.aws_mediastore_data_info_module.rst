.. _community.missing_collection.aws_mediastore_data_info_module:


*****************************************************
community.missing_collection.aws_mediastore_data_info
*****************************************************
...
--------
- Get Information about AWS Elemental Mediastore Data.
- https://docs.aws.amazon.com/mediastore/latest/apireference/API_Operations_AWS_Elemental_MediaStore_Data_Plane.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of items?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_items` is defined and success.</td>
                <td>
