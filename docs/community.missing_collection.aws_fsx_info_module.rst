.. _community.missing_collection.aws_fsx_info_module:


*****************************************
community.missing_collection.aws_fsx_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get details of backups for given <em>ids</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_data_repository_tasks</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details of data repository tasks of given <em>ids</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_file_systems</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details of filesystems of given <em>ids</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>can be list of backup ids?</div>
                        <div>can be list of file system ids?</div>
                        <div>can be list of task ids?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_backups` is defined and success.</td>
                <td>
                            <div>details about backups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>data_repository_tasks</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when `describe_data_repository_tasks` is defined and success.</td>
                <td>
                            <div>details about data repository tasks.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_file_systems` is defined and success.</td>
                <td>
                            <div>details about filesystems.</div>
                    <br/>
                </td>
            </tr>
    </table>
