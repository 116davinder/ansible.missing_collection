.. _community.missing_collection.aws_emr_containers_info_module:


****************************************************
community.missing_collection.aws_emr_containers_info
****************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>id of emr virtual cluster.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>list of job run states to filter results.</div>
                        <div>can be combination of following &#x27;PENDING&#x27;, &#x27;SUBMITTED&#x27;, &#x27;RUNNING&#x27;, &#x27;FAILED&#x27;, &#x27;CANCELLED&#x27;, &#x27;CANCEL_PENDING&#x27;, &#x27;COMPLETED&#x27;.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of job runs for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_managed_endpoints</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of managed endpoints for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>managed_endpoint_states</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                    </div>
                ...
                <td>
                        <div>list of job managed endpoints states to filter results.</div>
                        <div>can be combination of following &#x27;CREATING&#x27;, &#x27;ACTIVE&#x27;, &#x27;TERMINATING&#x27;, &#x27;TERMINATED&#x27;, &#x27;TERMINATED_WITH_ERRORS&#x27;.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>list of all emr virtual clusters.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_job_runs` is defined and success</td>
                <td>
                            <div>list of job runs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>managed_endpoints</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_managed_endpoints` is defined and success</td>
                <td>
                            <div>list of managed endpoints.</div>
                    <br/>
                </td>
            </tr>
    </table>
