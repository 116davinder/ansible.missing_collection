.. _community.missing_collection.aws_ses_info_module:


*****************************************
community.missing_collection.aws_ses_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of identities for given <em>identity_type</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_receipt_rule_sets</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get receipt_rule_sets?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get templates?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>get of custom_verification_email_templates.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_identities` is defined and success.</td>
                <td>
                            <div>list of identities.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>receipt_rule_sets</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_receipt_rule_sets` is defined and success.</td>
                <td>
                            <div>list of receipt_rule_sets.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_templates` is defined and success.</td>
                <td>
