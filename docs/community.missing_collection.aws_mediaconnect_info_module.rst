.. _community.missing_collection.aws_mediaconnect_info_module:


**************************************************
community.missing_collection.aws_mediaconnect_info
**************************************************
...
--------
- Get Information about AWS Elemental MediaConnect.
- https://docs.aws.amazon.com/mediaconnect/latest/api/resources.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of entitlements?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of flows?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_entitlements` is defined and success.</td>
                <td>
                            <div>list of entitlements.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_flows` is defined and success.</td>
                <td>
