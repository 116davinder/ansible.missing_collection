.. _community.missing_collection.aws_forecast_info_module:


**********************************************
community.missing_collection.aws_forecast_info
**********************************************
...
--------
- Get Information about Amazon Forecast Service.
- https://docs.aws.amazon.com/forecast/latest/dg/API_Operations_Amazon_Forecast_Service.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of dataset groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of dataset import jobs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of datasets?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_forecast_export_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of forecast export jobs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_predictor_backtest_export_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of predictor backtest export jobs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of predictors?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>list of dataset groups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                            <div>list of dataset import jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>forecast_export_jobs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_forecast_export_jobs` is defined and success</td>
                <td>
                            <div>list of forecast export jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>predictor_backtest_export_jobs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_predictor_backtest_export_jobs` is defined and success</td>
                <td>
                            <div>list of predictor backtest export jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_predictors` is defined and success</td>
                <td>
                            <div>list of predictors.</div>
                    <br/>
                </td>
            </tr>
    </table>
