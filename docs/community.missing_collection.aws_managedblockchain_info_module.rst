.. _community.missing_collection.aws_managedblockchain_info_module:


*******************************************************
community.missing_collection.aws_managedblockchain_info
*******************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of networks?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of nodes for given <em>id</em>)?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_proposal_votes</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of proposal_votes for given <em>id</em> and <em>proposal_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of proposals for given <em>id</em>)?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_networks` is defined and success.</td>
                <td>
                            <div>list of networks.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>when `list_proposal_votes` is defined and success.</td>
                <td>
                            <div>list of proposal_votes.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_proposals` is defined and success.</td>
                <td>
