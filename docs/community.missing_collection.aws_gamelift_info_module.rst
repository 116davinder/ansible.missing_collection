.. _community.missing_collection.aws_gamelift_info_module:


**********************************************
community.missing_collection.aws_gamelift_info
**********************************************
...
--------
- Get Information about Amazon Gamelift.
- https://docs.aws.amazon.com/gamelift/latest/apireference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>name of game server group.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of aliases?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of builds?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of fleets for given <em>build_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_game_server_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of game server groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_game_servers</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of game servers?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get details of scripts?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>SIMPLE</b>&nbsp;&larr;</div></li>
                                    <li>TERMINAL</li>
                        </ul>
                </td>
                <td>
                        <div>type of routing strategy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>INITIALIZED</li>
                                    <li><div style="color: blue"><b>READY</b>&nbsp;&larr;</div></li>
                                    <li>FAILED</li>
                        </ul>
                </td>
                <td>
                        <div>status of build.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_aliases` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `list_builds` is defined and success.</td>
                <td>
                            <div>list of builds.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>game_server_groups</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_game_server_groups` is defined and success.</td>
                <td>
                            <div>list of game_server_groups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_game_servers` is defined and success.</td>
                <td>
                            <div>list of game_servers.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_scripts` is defined and success.</td>
                <td>
