.. _community.missing_collection.aws_outposts_info_module:


**********************************************
community.missing_collection.aws_outposts_info
**********************************************
...
--------
- Get Information about Amazon outposts.
- https://docs.aws.amazon.com/outposts/latest/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of outposts?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get sites?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_outposts` is defined and success.</td>
                <td>
                            <div>list of outposts.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_sites` is defined and success.</td>
                <td>
                            <div>get of sites.</div>
                    <br/>
                </td>
            </tr>
    </table>
