.. _community.missing_collection.aws_redshift_data_info_module:


***************************************************
community.missing_collection.aws_redshift_data_info
***************************************************
...
--------
- Get Information about Amazon Redshift Data API Service.
- https://docs.aws.amazon.com/redshift-data/latest/APIReference/API_Operations.html
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: cluster_identifier</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of statements for given <em>status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_databases` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `list_statements` is defined and success.</td>
                <td>
