.. _community.missing_collection.consul_policy_info_module:
...
--------
- Get information from Consul (ACL Policy).
- https://www.consul.io/api-docs/acl/policies
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>This endpoint lists all the ACL policies.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>This endpoint reads an ACL policy with the given <em>id</em> or <em>name</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>the name of the acl policy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div><b>Enterprise</b> the namespace to lookup the policy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
