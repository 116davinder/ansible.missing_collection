.. _community.missing_collection.aws_kinesis_video_archived_media_info_module:


******************************************************************
community.missing_collection.aws_kinesis_video_archived_media_info
******************************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of fragments for given stream <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_fragments` is defined and success.</td>
                <td>
                            <div>list of fragments.</div>
                    <br/>
                </td>
            </tr>
    </table>
