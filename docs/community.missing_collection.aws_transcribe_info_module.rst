.. _community.missing_collection.aws_transcribe_info_module:


************************************************
community.missing_collection.aws_transcribe_info
************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of language_models for given <em>name_contains</em> and <em>status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_medical_transcription_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get medical_transcription_jobs for given <em>name_contains</em> and <em>status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_transcription_jobs</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of transcription_jobs for given <em>name_contains</em> and <em>status</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_vocabulary_filters</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get vocabulary_filters?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>name contains to filter results.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>IN_PROGRESS</li>
                                    <li>FAILED</li>
                                    <li><div style="color: blue"><b>COMPLETED</b>&nbsp;&larr;</div></li>
                                    <li>QUEUED</li>
                        </ul>
                </td>
                <td>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_language_models` is defined and success.</td>
                <td>
                            <div>list of language_models.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>medical_transcription_jobs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_medical_transcription_jobs` is defined and success.</td>
                <td>
                            <div>list of medical_transcription_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_transcription_jobs` is defined and success.</td>
                <td>
                            <div>list of transcription_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>vocabulary_filters</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_vocabulary_filters` is defined and success.</td>
                <td>
                            <div>get details of vocabulary_filters.</div>
                    <br/>
                </td>
            </tr>
    </table>
