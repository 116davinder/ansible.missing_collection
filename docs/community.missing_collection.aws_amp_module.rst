.. _community.missing_collection.aws_amp_module:


************************************
community.missing_collection.aws_amp
************************************

**Create / Update AWS Prometheus Service.**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>alias for aws amp service.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>unique client token for aws amp service.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>new alias for amp resource.</div>
                        <div>Used only when updating amp resources.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to create/delete/update amp resource?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>aws amp workspace unique id.</div>
                        <div>Used only when deleting/updating amp resources.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `state=present` and success</td>
                <td>
                            <div>arn of workspace.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:aps:us-east-1:xxxxxx:workspace/ws-xxxxxxxxx-92fe-93cb8d9bff79</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>when `state=present` and success</td>
                <td>
                            <div>input `client_token` used for workspace.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">123456</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>when `state=present` and success</td>
                <td>
                            <div>status of workspace.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;status_code&#x27;: &#x27;ACTIVE&#x27;}</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>when `state=present` and success</td>
                <td>
                            <div>id of workspace.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">ws-xxxxxxxxx-92fe-93cb8d9bff79</div>
                </td>
            </tr>
    </table>
    <br/><br/>
