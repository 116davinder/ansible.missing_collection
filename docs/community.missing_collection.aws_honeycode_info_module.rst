.. _community.missing_collection.aws_honeycode_info_module:


***********************************************
community.missing_collection.aws_honeycode_info
***********************************************
...
--------
- Get Information about Amazon Honey Code.
- https://docs.aws.amazon.com/honeycode/latest/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>id of workbook.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_table_columns</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of table_columns for workbook <em>id</em> and <em>table_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of table_rows for given workbook <em>id</em> and <em>table_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of tables for given workbook <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>list of row ids to filter results.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_table_columns` is defined and success.</td>
                <td>
                            <div>list of table_columns.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_table_rows` is defined and success.</td>
                <td>
                            <div>list of table_rows.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_tables` is defined and success.</td>
                <td>
