.. _community.missing_collection.aws_identitystore_info_module:


***************************************************
community.missing_collection.aws_identitystore_info
***************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>id of AWS SSO Directory.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of groups for given SSO <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of users for given SSO <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
