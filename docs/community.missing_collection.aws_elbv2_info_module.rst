.. _community.missing_collection.aws_elbv2_info_module:


*******************************************
community.missing_collection.aws_elbv2_info
*******************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>can be arn of load-balancer?</div>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_listener_certificates</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of listener certificates for given listener <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_listeners</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of listeners for given LB <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of rules for given listener <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_target_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of target groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>list of name of load-balancers.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>listener_certificates</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `describe_listener_certificates` is defined and success</td>
                <td>
                            <div>list of listener certificates.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_listeners` is defined and success</td>
                <td>
            ...
            <tr>
                ...
                <td>
                            <div>list of all load balancers.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_rules` is defined and success</td>
                <td>
            ...
            <tr>
                ...
                <td>when `describe_target_groups` is defined and success</td>
                <td>
                            <div>list of target groups.</div>
                    <br/>
                </td>
            </tr>
    </table>
