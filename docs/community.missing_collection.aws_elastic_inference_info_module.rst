.. _community.missing_collection.aws_elastic_inference_info_module:


*******************************************************
community.missing_collection.aws_elastic_inference_info
*******************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_accelerator_offerings</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details of accelerators offerings for given <em>location_type</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_accelerator_types</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details of accelerators types?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_accelerators</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details of accelerators for given <em>ids</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>ids of the accelerators.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>region</b>&nbsp;&larr;</div></li>
                                    <li>availability-zone</li>
                                    <li>availability-zone-id</li>
                        </ul>
                </td>
                <td>
                        <div>accelerator location type.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>accelerator_offerings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `describe_accelerator_offerings` and `location_type` are defined and success</td>
                <td>
                            <div>details of accelerators offerings.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>accelerator_types</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `describe_accelerator_types` is defined and success</td>
                <td>
                            <div>details of accelerators types.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_accelerators` and `ids` are defined and success</td>
                <td>
                            <div>details of accelerators.</div>
                    <br/>
                </td>
            </tr>
    </table>
