.. _community.missing_collection.aws_s3outposts_info_module:


************************************************
community.missing_collection.aws_s3outposts_info
************************************************
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_endpoints` is defined and success.</td>
                <td>
