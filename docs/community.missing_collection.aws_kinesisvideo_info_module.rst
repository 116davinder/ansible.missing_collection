.. _community.missing_collection.aws_kinesisvideo_info_module:


**************************************************
community.missing_collection.aws_kinesisvideo_info
**************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of signaling_channels?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>signaling_channels</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_signaling_channels` is defined and success.</td>
                <td>
                            <div>list of signaling_channels.</div>
                    <br/>
                </td>
            </tr>
            <tr>
