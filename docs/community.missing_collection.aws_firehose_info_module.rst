.. _community.missing_collection.aws_firehose_info_module:


**********************************************
community.missing_collection.aws_firehose_info
**********************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get details of given <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>name of delivery stream.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_delivery_stream` is defined and success</td>
                <td>
                            <div>details of delivery stream.</div>
                    <br/>
                </td>
            </tr>
            <tr>
