.. _community.missing_collection.aws_kinesisanalyticsv2_info_module:


********************************************************
community.missing_collection.aws_kinesisanalyticsv2_info
********************************************************
...
--------
- Get Information about Amazon Kinesis Analytics V2.
- https://docs.aws.amazon.com/kinesisanalytics/latest/apiv2/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_application_snapshots</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of  snapshots for given application <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>application_snapshots</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_application_snapshots` is defined and success.</td>
                <td>
                            <div>list of application snapshots.</div>
                    <br/>
                </td>
            </tr>
            <tr>
