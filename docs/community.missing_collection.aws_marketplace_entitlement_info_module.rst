.. _community.missing_collection.aws_marketplace_entitlement_info_module:


*************************************************************
community.missing_collection.aws_marketplace_entitlement_info
*************************************************************
...
--------
- Get Information about AWS Marketplace Entitlement Service.
- https://docs.aws.amazon.com/marketplaceentitlement/latest/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of change_sets for given <em>product_code</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `get_entitlements` is defined and success.</td>
                <td>
