.. _community.missing_collection.aws_ecr_public_info_module:


************************************************
community.missing_collection.aws_ecr_public_info
************************************************
...
--------
- Get Information about Amazon Elastic Container Registry Public (ECR Public).
- https://docs.aws.amazon.com/AmazonECRPublic/latest/APIReference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get details of ecr_public images for given <em>id</em> and <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_repositories</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details of repository for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>id of the ecr_public registry.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>name of ecr_public repository.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_images`, `name` and `id` are defined and success</td>
                <td>
                            <div>list of images for given repository and registry.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                            <div>detailed information about all registries.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_repositories` and `id` are defined and success</td>
                <td>
                            <div>detailed information about the repositories.</div>
                    <br/>
                </td>
            </tr>
    </table>
