.. _community.missing_collection.aws_kafka_info_module:


*******************************************
community.missing_collection.aws_kafka_info
*******************************************
...
--------
- Get Information about Amazon MSK cluster.
- https://docs.aws.amazon.com/msk/1.0/apireference/resources.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>can be config arn?</div>
                        <div>can be cluster arn?</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: config_arn, cluster_arn</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of cluster_operations for given cluster <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_configuration_revisions</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of configuration revisions for given config <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_configurations</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of configurations?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of nodes for given cluster <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_scram_secrets</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of scram secrets for given cluster <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>cluster_operations</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_cluster_operations` is defined and success.</td>
                <td>
                            <div>list of cluster_operations.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>configuration_revisions</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_configuration_revisions` is defined and success.</td>
                <td>
                            <div>list of configuration_revisions.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_configurations` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `list_nodes` is defined and success.</td>
                <td>
                            <div>list of nodes.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_scram_secrets` is defined and success.</td>
                <td>
                            <div>list of scram_secrets.</div>
                    <br/>
                </td>
            </tr>
    </table>
