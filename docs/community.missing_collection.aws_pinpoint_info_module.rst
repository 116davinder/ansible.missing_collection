.. _community.missing_collection.aws_pinpoint_info_module:


**********************************************
community.missing_collection.aws_pinpoint_info
**********************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get adm_channel for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>get_apns_channel</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get apns_channel for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>get_application_settings</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get application_settings for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get apps?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>get_baidu_channel</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get baidu_channel for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get campaigns for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get export_jobs for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get import_jobs for given application <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>id of application.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: application_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `get_adm_channel` is defined and success.</td>
                <td>
                            <div>list of adm_channel.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_apns_channel` is defined and success.</td>
                <td>
                            <div>get of apns_channel.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>application_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when `get_application_settings` is defined and success.</td>
                <td>
                            <div>list of application_settings.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_apps` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `get_baidu_channel` is defined and success.</td>
                <td>
                            <div>list of baidu_channel.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_campaigns` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `get_export_jobs` is defined and success.</td>
                <td>
                            <div>list of export_jobs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_import_jobs` is defined and success.</td>
                <td>
                            <div>list of import_jobs.</div>
                    <br/>
                </td>
            </tr>
    </table>
