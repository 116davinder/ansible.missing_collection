.. _community.missing_collection.aws_mq_info_module:


****************************************
community.missing_collection.aws_mq_info
****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>broker id.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: broker_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of brokers?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get configurations?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of users for given broker <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_brokers` is defined and success.</td>
                <td>
                            <div>list of brokers.</div>
                    <br/>
                </td>
            </tr>
            <tr>
