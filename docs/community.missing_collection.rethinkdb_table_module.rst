.. _community.missing_collection.rethinkdb_table_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>soft</li>
                                    <li><div style="color: blue"><b>hard</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
                        <div>if set to soft, writes will be acknowledged by the server immediately and flushed to disk in the background.</div>
                        <div>{&#x27;The default is hard&#x27;: &#x27;acknowledgment of writes happens after data has been written to disk.&#x27;}</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">"id"</div>
                </td>
                <td>
                        <div>name of the primary key.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when success for state `present/absent`.</td>
                <td>
                            <div>result of create/delete table query.</div>
                    <br/>
                </td>
            </tr>
    </table>
