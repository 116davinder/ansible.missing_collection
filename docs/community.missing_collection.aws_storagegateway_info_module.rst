.. _community.missing_collection.aws_storagegateway_info_module:


****************************************************
community.missing_collection.aws_storagegateway_info
****************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>arn of the storage gateway.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: gateway_arn</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_automatic_tape_creation_policies</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of automatic_tape_creation_policies for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_file_shares</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get file_shares for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_file_system_associations</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of file_system_associations for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get gateways?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_local_disks</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get local_disks for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get tape_pools?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get tapes for given <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>automatic_tape_creation_policies</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_automatic_tape_creation_policies` is defined and success.</td>
                <td>
                            <div>list of automatic_tape_creation_policies.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_file_shares` is defined and success.</td>
                <td>
                            <div>get of file_shares.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>file_system_associations</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_file_system_associations` is defined and success.</td>
                <td>
                            <div>list of file_system_associations.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_gateways` is defined and success.</td>
                <td>
                            <div>list of gateways.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_local_disks` is defined and success.</td>
                <td>
                            <div>list of local_disks.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_tape_pools` is defined and success.</td>
                <td>
                            <div>list of tape_pools.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_tapes` is defined and success.</td>
                <td>
                            <div>list of tapes.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_volumes` is defined and success.</td>
                <td>
