.. _community.missing_collection.aws_rekognition_info_module:


*************************************************
community.missing_collection.aws_rekognition_info
*************************************************
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: collection_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of collections?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get faces for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_stream_processors</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of stream_processors?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_collections` is defined and success.</td>
                <td>
                            <div>list of collections.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_faces` is defined and success.</td>
                <td>
                            <div>get of faces.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>stream_processors</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_stream_processors` is defined and success.</td>
                <td>
                            <div>list of stream_processors.</div>
                    <br/>
                </td>
            </tr>
    </table>
