    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>type of operation on contact groups.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>email_addresses_csv</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
            ...
            <tr>
                ...
                <td>
                        <div>Comma separated list of integration IDs.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>mobile_numbers_csv</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>Comma separated list of international format mobile phone numbers.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>URL or IP address of an endpoint to push uptime events.</div>
                        <div>Currently this only supports HTTP GET endpoints.</div>
                        <div>{&#x27;<em>example</em>&#x27;: &#x27;https://www.google.com&#x27;}</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
