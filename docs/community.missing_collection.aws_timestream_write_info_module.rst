.. _community.missing_collection.aws_timestream_write_info_module:


******************************************************
community.missing_collection.aws_timestream_write_info
******************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get tables for given <em>database_name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
