.. _community.missing_collection.aws_marketplace_catalog_info_module:


*********************************************************
community.missing_collection.aws_marketplace_catalog_info
*********************************************************
...
--------
- Get Information about AWS Marketplace Catalog Service.
- https://docs.aws.amazon.com/marketplace-catalog/latest/api-reference/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>type of the entity.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_change_sets</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of change_sets for given <em>catalog</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of entities for given <em>catalog</em>) and <em>entity_type</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_change_sets` is defined and success.</td>
                <td>
                            <div>list of change_sets.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_entities` is defined and success.</td>
                <td>
