.. _community.missing_collection.aws_sso_info_module:


*****************************************
community.missing_collection.aws_sso_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of account_roles for given <em>access_token</em> and <em>account_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get accounts for given <em>access_token</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_account_roles` is defined and success.</td>
                <td>
                            <div>list of account_roles.</div>
                    <br/>
                </td>
            </tr>
            <tr>
