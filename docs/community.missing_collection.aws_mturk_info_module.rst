.. _community.missing_collection.aws_mturk_info_module:


*******************************************
community.missing_collection.aws_mturk_info
*******************************************
...
--------
- Get Information about Amazon Mechanical Turk (MTurk).
- https://docs.aws.amazon.com/AWSMechTurk/latest/AWSMturkAPI/ApiReference_OperationsArticle.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>hit id.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: hit_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_assignments_for_hit</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of assignments_for_hit for given hit <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_bonus_payments</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get bonus_payments for given hit <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of hits?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_worker_blocks</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get worker_blocks?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>assignments_for_hit</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_assignments_for_hit` is defined and success.</td>
                <td>
                            <div>list of assignments_for_hit.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_bonus_payments` is defined and success.</td>
                <td>
                            <div>get of bonus_payments.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_hits` is defined and success.</td>
                <td>
                            <div>list of hits.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_worker_blocks` is defined and success.</td>
                <td>
                            <div>list of worker_blocks.</div>
                    <br/>
                </td>
            </tr>
    </table>
