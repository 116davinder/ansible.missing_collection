    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Determines if the check is running or not.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>alert_channel_subscriptions</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                ...
                <td>
                        <div>List of alert channel subscriptions.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>type of operation on checks.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Setting this to &quot;true&quot; will trigger a retry when a check fails from the failing region and another,</div>
                        <div>randomly selected region before marking the check as failed.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>A valid piece of Node.js code to run in the setup phase.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>local_tear_down_script</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>A valid piece of Node.js code to run in the teardown phase.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">["ap-south-1"]</div>
                </td>
                <td>
                        <div>An array of one or more data center locations where to run the this check.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Determines if any notifications will be send out when a check fails and/or recovers.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>2021.06</b>&nbsp;&larr;</div></li>
                                    <li>2020.01</li>
                        </ul>
                </td>
                <td>
                        <div>The runtime version, i.e. fixed set of runtime dependencies, used to execute this check.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>An ID reference to a snippet to use in the setup phase of an API check.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>An ID reference to a snippet to use in the teardown phase of an API check.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>When true, the account level alert setting will be used,</div>
                        <div>not the alert setting defined on this check.</div>
                </td>
            </tr>
    </table>
    <br/>
