.. _community.missing_collection.aws_emr_info_module:


*****************************************
community.missing_collection.aws_emr_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>list of cluster states to filter results.</div>
                        <div>can be combination of following &#x27;STARTING&#x27;, &#x27;BOOTSTRAPPING&#x27;, &#x27;RUNNING&#x27;, &#x27;WAITING&#x27;, &#x27;TERMINATING&#x27;, &#x27;TERMINATED&#x27;, &#x27;TERMINATED_WITH_ERRORS&#x27;</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>id of emr cluster.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_bootstrap_actions</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of bootstrap actions for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_instance_fleets</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of instance fleets for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_instance_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of instance groups for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of steps for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of studios for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>bootstrap_actions</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_bootstrap_actions` is defined and success</td>
                <td>
                            <div>list of bootstrap actions.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                            <div>list of all emr clusters.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_instance_fleets` is defined and success</td>
                <td>
                            <div>list of instance fleets.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_instance_groups` is defined and success</td>
                <td>
                            <div>list of instance groups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_steps` is defined and success</td>
                <td>
                            <div>list of steps.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_studios` is defined and success</td>
                <td>
