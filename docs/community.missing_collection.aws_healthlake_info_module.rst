.. _community.missing_collection.aws_healthlake_info_module:


************************************************
community.missing_collection.aws_healthlake_info
************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>status of datastore to filter results.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get details of fhir_datastore for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_fhir_export_job</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details export job for given <em>id</em> and <em>job_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>describe_fhir_import_job</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get details import job for given <em>id</em> and <em>job_id</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>can be id of export job or import job?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_fhir_datastores</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of fhir_datastores?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_fhir_datastore` is defined and success.</td>
                <td>
                            <div>details of fhir_datastore.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_fhir_datastores` is defined and success.</td>
                <td>
                            <div>list of fhir_datastores.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_fhir_export_job` is defined and success.</td>
                <td>
                            <div>list of fhir_export_job.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `describe_fhir_import_job` is defined and success.</td>
                <td>
                            <div>list of fhir_import_job.</div>
                    <br/>
                </td>
            </tr>
    </table>
