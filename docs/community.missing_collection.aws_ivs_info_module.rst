.. _community.missing_collection.aws_ivs_info_module:


*****************************************
community.missing_collection.aws_ivs_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>channel arn.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: channel_arn</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of playback_key_pairs?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>list_stream_keys</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>do you want to get list of stream_keys for given channel <em>arn</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>playback_key_pairs</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_playback_key_pairs` is defined and success.</td>
                <td>
                            <div>list of playback_key_pairs.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_stream_keys` is defined and success.</td>
                <td>
                            <div>list of stream_keys.</div>
                    <br/>
                </td>
            </tr>
            <tr>
