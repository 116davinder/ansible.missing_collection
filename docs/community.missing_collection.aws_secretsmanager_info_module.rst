.. _community.missing_collection.aws_secretsmanager_info_module:


****************************************************
community.missing_collection.aws_secretsmanager_info
****************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get details of secret for given <em>id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get of secrets?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `describe_secret` is defined and success.</td>
                <td>
                            <div>details of secret.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_secrets` is defined and success.</td>
                <td>
                            <div>get of secrets.</div>
                    <br/>
                </td>
            </tr>
    </table>
