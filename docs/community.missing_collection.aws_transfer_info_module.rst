.. _community.missing_collection.aws_transfer_info_module:


**********************************************
community.missing_collection.aws_transfer_info
**********************************************
...
--------
- Get Information about AWS Transfer Family.
- https://docs.aws.amazon.com/transfer/latest/userguide/API_Operations.html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of security_policies?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get servers?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of users for given <em>server_id</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>system-assigned unique identifier for a server that has users assigned to it.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_security_policies` is defined and success.</td>
                <td>
                            <div>list of security_policies.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_servers` is defined and success.</td>
                <td>
