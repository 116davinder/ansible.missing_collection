.. _community.missing_collection.aws_ecr_info_module:


*****************************************
community.missing_collection.aws_ecr_info
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>id of the ecr registry.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of ecr images for given <em>id</em> and <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>name of ecr repository.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>tag status on ecr images.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_images`, `name` and `id` are defined and success</td>
                <td>
            ...
            <tr>
                ...
                <td>
                            <div>detailed information registry.</div>
                    <br/>
                </td>
            </tr>
            <tr>
