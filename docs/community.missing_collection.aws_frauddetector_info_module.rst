.. _community.missing_collection.aws_frauddetector_info_module:


***************************************************
community.missing_collection.aws_frauddetector_info
***************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of entity types?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of external models?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of labels?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of models?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of outcomes?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of rules?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of variables?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `get_detectors` is defined and success</td>
                <td>
            ...
            <tr>
                ...
                <td>when `get_entity_types` is defined and success</td>
                <td>
                            <div>list of get entity types</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_event_types` is defined and success</td>
                <td>
                            <div>list of event types</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_external_models` is defined and success</td>
                <td>
                            <div>list of external models</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_labels` is defined and success</td>
                <td>
                            <div>list of labels.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_models` is defined and success</td>
                <td>
            ...
            <tr>
                ...
                <td>when `get_outcomes` is defined and success</td>
                <td>
                            <div>list of outcomes.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `get_rules` is defined and success</td>
                <td>
            ...
            <tr>
                ...
                <td>when `get_variables` is defined and success</td>
                <td>
