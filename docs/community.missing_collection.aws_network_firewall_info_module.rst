.. _community.missing_collection.aws_network_firewall_info_module:


******************************************************
community.missing_collection.aws_network_firewall_info
******************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of firewall_policies?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get firewalls?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of rule_groups?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <b>firewall_policies</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                    </div>
                </td>
                <td>when `list_firewall_policies` is defined and success.</td>
                <td>
                            <div>list of firewall_policies.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_firewalls` is defined and success.</td>
                <td>
                            <div>list of firewalls.</div>
                    <br/>
                </td>
            </tr>
            <tr>
