.. _community.missing_collection.aws_route53domains_info_module:


****************************************************
community.missing_collection.aws_route53domains_info
****************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get domain_detail for given domain <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of domains?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: domain_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `get_domain_detail` is defined and success.</td>
                <td>
                            <div>get of domain_detail.</div>
                    <br/>
                </td>
            </tr>
            <tr>
