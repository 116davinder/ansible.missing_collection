.. _community.missing_collection.aws_lookoutvision_info_module:


***************************************************
community.missing_collection.aws_lookoutvision_info
***************************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>do you want to get list of dataset_entries for given project <em>name</em> and <em>dataset_type</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of models for given project <em>name</em>?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>do you want to get list of projects?</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: project_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when `list_dataset_entries` is defined and success.</td>
                <td>
                            <div>list of dataset_entries.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when `list_models` is defined and success.</td>
                <td>
            ...
            <tr>
                ...
                <td>when `list_projects` is defined and success.</td>
                <td>
