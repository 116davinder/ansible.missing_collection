...
DOCUMENTATION = """
module: aws_waf_regional_info
short_description: Get Information about AWS WAF Classic Regional.
description:
  - Get Information about AWS WAF Classic Regional.
  - U(https://docs.aws.amazon.com/waf/latest/APIReference/API_Operations_AWS_WAF_Regional.html)
version_added: 0.1.0
options:
  id:
    description:
...
def _waf_regional(client, module):
    try:
        ...
        module.fail_json_aws(e, msg='Failed to fetch AWS WAF Classic Regional details')
...
def main():
    ...
    client = module.client('waf-regional', retry_decorator=AWSRetry.exponential_backoff())
    it, paginate = _waf_regional(client, module)
