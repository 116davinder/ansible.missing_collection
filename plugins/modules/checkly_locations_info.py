...
DOCUMENTATION = """
module: checkly_locations_info
short_description: Get information from checkly about Locations.
description:
  - Get information from checkly about Locations.
  - U(https://www.checklyhq.com/docs/api#tag/Location)
version_added: 0.3.0
options:
  url:
    description:
    ...
    required: false
    type: str
    default: 'https://api.checklyhq.com/v1/locations'
  api_key:
    description:
      - api key for checkly.
    required: true
...
def main():
    argument_spec = dict(
        url=dict(default="https://api.checklyhq.com/v1/locations"),
